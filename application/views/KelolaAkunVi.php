							...
							<nav class="navbar navbar-inverse" style="background-color:#44749d">
							  <div class="container-fluid">
								...
								<div class="navbar-header">
								  ...
								  <a class="navbar-brand" href="javascript:void(0);">| Kelola Akun</a>
								</div>
...
<h1 style="padding-left: 20px">Tambah Data Pengguna</h1>
				
				<div class="pmd-card-body">	
					<form class="form-horizontal" action="<?= base_url() ?>KelolaAkunCon/prosesTambahAkun" method="POST" role="form">
						<div class="form-group pmd-textfield">
							<label for="inputEmail3" class="col-sm-2 control-label"><strong>Nama Pegawai</strong></label>
							<div class="col-sm-10">
								<input required  name="namapgw" class="form-control input-sm" id="inputEmail3" type="text" ><span class="pmd-textfield-focused"></span>
							</div>
						</div>
						<div class="form-group pmd-textfield">
							...
							<div class="col-sm-10">
								...
								<div class="fg-line">
									<input name="user" length="10" required class="form-control input-sm" id="inputPassword3"  type="text"><span class="pmd-textfield-focused"></span>
								</div>
							</div>
						</div>
						<div class="form-group pmd-textfield">
							...
							<div class="col-sm-10">
								...
								<div class="fg-line">
									<input name="pass" required class="form-control input-sm" id="inputPassword3"  type="password"><span class="pmd-textfield-focused"></span>
								</div>
							</div>
						</div>
					...
					<div class="form-group pmd-textfield">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								...
								<button name="simpan" type="submit" onclick="pesanSimpan()" class="btn  btn-primary pmd-checkbox-ripple-effect">Simpan</button>
							</div>
...
var pesan = confirm("Apakah anda yakin ingin menghapus Pengguna dengan Username "+id+" ?");
		if(pesan){
			window.location.href ="<?php echo site_url('KelolaAkunCon/prosesDeletePengguna/');?>"+id;
		}
	}
(function() {
  "use strict";
...
var pesan = confirm("Apakah anda yakin ingin menyimpan data Pengguna Baru ?");
		if(pesan){
			window.location.href ="<?php echo site_url('KelolaAkunCon/prosesTambahAkun/');?>";
		}
	}
(function() {
  "use strict";
